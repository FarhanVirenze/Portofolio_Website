      ...
      items: [
        {
          ...
          imageUrl: 'portofoliowebsite',
          status: 'My personal website, I created this website to display my profile, skills and projects. As well as my place to try new technology.',
          tech: 'VueJS, Tailwind',
          github: 'https://github.com/rakha-elctrnx/Portofolio-v2',
          demo: 'https://muhamadfarhanportofolio.vercel.app/'
        },
        {
          id: 2,
          name: 'PPKO HIMFA UMY Website',
          imageUrl: 'ppko',
          status: 'This is mobile-friendly website of PPKO HIMFA UMY offers details about the program, events, and organization in a sleek, user-friendly design. ',
          tech: 'React JS, Tailwind',
          github: 'https://github.com/rakha-elctrnx/muslim-companion',
          demo: 'https://ppko-website.vercel.app/'
        },
        {
          id: 3,
          name: 'Website Streaming Movies & Series',
          imageUrl: 'moviehub',
          status: 'A web application for streaming movies and series, developed as a final project for the Web Application Programming course.',
          tech: 'React JS, MongoDB',
          github: 'https://github.com/FarhanVirenze/Kelompok1_C_UAS.git',
          demo: 'null'
        },
        {
          id: 4,
          name: 'Website Amba Laundry',
          imageUrl: 'laundry',
          status: 'A responsive website for a laundry service business, built using HTML, CSS, and JavaScript',
          tech: 'HTML, CSS, JavaScript',
          github: 'https://github.com/FarhanVirenze/WebsiteAmbaLaundry.git',
          demo: 'https://farhanvirenze.github.io/WebsiteAmbaLaundry/'
        },
        {
          id: 5,
          name: 'Advance Python Calculator',
          imageUrl: 'calculator',
          status: 'A GUI-based calculator application developed using Python Tkinter library.',
          tech: 'Python, Tkinter',
          github: 'https://github.com/FarhanVirenze/Python_Calculator_Intermediate.git',
          demo: 'null'
        },
        {
          id: 6,
          name: 'Maze Python',
          imageUrl: 'maze',
          status: 'A GUI-based maze game application developed using Python Tkinter library.',
          tech: 'Python, Tkinter',
          github: 'https://github.com/FarhanVirenze/Maze-Tkinter-Python.git',
          demo: 'null'
        },
        {
          id: 7,
          name: 'Library App',
          imageUrl: 'aplikasiperpustakaan',
          status: 'A library app developed with Android Studio, featuring book management, member management, borrowing, and returning books.',
          tech: 'Android, Kotlin',
          github: 'https://github.com/FarhanVirenze/A11_139.git',
          demo: 'null'
        },
        {
          id: 7,
          name: 'Diskominfo Flask Python Service Submission Website',
          imageUrl: 'diskominfodiy',
          status: 'Website application to manage public service submissions, allowing users to fill out submission forms, and view reports.',
          tech: 'Python, Flask, HTML, CSS, Bootstrap',
          github: 'https://github.com/FarhanVirenze/Diskominfo_Python_Flask.git',
          demo: 'null'
        },
        {
          id: 7,
          name: 'WeatherNow',
          imageUrl: 'weather',
          status: 'A weather app developed using Flask and Python for real-time weather updates.',
          tech: 'Flask, Python, OpenWeatherAPI',
          github: 'https://github.com/FarhanVirenze/WeatherNow.git',
          demo: 'null'
        },
      ]
    };
