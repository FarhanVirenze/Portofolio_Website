<template>
  <main class="mt-10 md:mt-1 flex flex-col-reverse gap-8 items-center md:flex-row md:gap-16 md:justify-center min-h-[65vh] md:min-h-[80vh]">
    <div class="space-y-2 text-center md:text-left px-10">
      <p class="text-amber-200">Hey there, I'm</p>
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Muhamad Farhan</h1>
      <div class="py-2">
        <h1
      ...
      <br>
      <!-- Tombol Download dengan efek suara -->
      <button 
        ...
        @click="playSound">
        <a href="/resume.pdf" download="Resume_CV_Muhamad_Farhan.pdf">
          Download Resume / CV
        </a>
      </button>
    </div>
    ...
    <div class="flex justify-center md:justify-start fadein-right">
      <img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
           class="w-10/12 md:h-auto rounded-full border-4 border-amber-200 pict" src="/img/Foto.png">
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Informatics Student", "Web Developer", "Mobile Developer", "Full-stack Engineer"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
  ...
  methods: {
    ...
    playSound() {
      var audio = new Audio('/assets/pop.mp3'); // Path ke file pop.mp3
      audio.play();
    }
  }
}
