...
function ProjectCard({ project, index }: { project: Project; index: number }) {
  ...
  return (
    <div 
      className="portfolio-card opacity-0 group flex flex-col bg-card border border-border rounded-2xl overflow-hidden shadow-sm hover:shadow-2xl hover:shadow-primary/10 hover:border-primary/30"
    >
      {/* Image */}
